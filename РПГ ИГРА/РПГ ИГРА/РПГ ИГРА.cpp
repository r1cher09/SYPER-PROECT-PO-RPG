...
int main() {
    ...
    int vibor_igroka, vibor_igroka2, vibor_igroka3, vibor_igroka4, vibor_igroka5=0, food, water, health, atk, enemyhealth, fight,money=0;
    ...
    for (r = 0; r < 1; r++) {
        ...
        do {
            ...
            cout << "|                                            |\n";
            cout << "|  |1|оглядеться |2|а как играть?            |\n";
                            ...
                            this_thread::sleep_for(chrono::nanoseconds(3500000000)); \
                                ...
                                if (vibor_igroka == 1) {
                                    ...
                                    do {
                                        ...
                                        cout << "|____________________________________________|\n";
                                        cin >> vibor_igroka2;
                                    } while (vibor_igroka2 != 1 && vibor_igroka != 2);
                                }
                                if (vibor_igroka == 2) {
                                    cout << "______________________________________________\n";
                                    cout << "|                                            |\n";
